  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        attendance: {
          DEFAULT: "hsl(var(--attendance))",
          foreground: "hsl(var(--attendance-foreground))",
        },
        complaints: {
          DEFAULT: "hsl(var(--complaints))",
          foreground: "hsl(var(--complaints-foreground))",
        },
        safety: {
        ...
        career: {
          DEFAULT: "hsl(var(--career))",
          foreground: "hsl(var(--career-foreground))",
        },
        wellness: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'radial-gradient(at 40% 20%, hsl(221, 68%, 40%) 0px, transparent 50%), radial-gradient(at 80% 0%, hsl(45, 93%, 45%) 0px, transparent 50%), radial-gradient(at 0% 50%, hsl(221, 68%, 35%) 0px, transparent 50%)',
      },
    },
  },
